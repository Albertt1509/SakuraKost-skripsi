...
export default function Pembayran() {
    ...
    const message = 'Hallo, Saya Tertarik Dengan Kos Milik Anda!';
    ...
    return (
        <>
            <div className="flex justify-end p-6 ">
                <div className="flex flex-col bg-white w-[65vh] sm:h-[50vh] p-4 shadow-lg">
                    <h1 className='font-bold text-2xl'>{formatNominal(kost.price)} /Bulan</h1>
            ...
            {isSaveClicked && !user && <Navigate to="/login" />}
        </>
    )
}